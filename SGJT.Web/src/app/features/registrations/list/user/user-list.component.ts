...
import { ColumnDefinition } from 'src/app/shared/models/column-definition.model';
...
export class UserListComponent implements OnInit {
  ...
  columns = [
    new ColumnDefinition("Nome", "nome"),
    new ColumnDefinition("Telefone", "telefone")
  ];
  ...
  listDefinition = new ListDefinition(this.pageTitle, this.registerURL, this.columns, this.dataSource);
